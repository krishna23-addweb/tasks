		...
		<div class="widget-shadow">
			...
			<div class="login-body">
				<form class="wow fadeInUp animated" data-wow-delay=".7s" method="post">
					...
					<input type="password" name="password" class="lock" name="password" placeholder="Password">
					...
					<input type="number" placeholder="Postal" required="" name="Postal">
...
if(isset($_POST['Register'])){
    ...
    $abc="Insert into User_register values('$fname','$email',$mobile,'$address','$state','$city',$postal,'$password')";
    echo $abc;
