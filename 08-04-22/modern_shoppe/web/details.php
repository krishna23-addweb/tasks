		...
		<div class="container">
			<div class="single-info">		
        		...
        		try{
					...
					$query1="select * from $table where Pid=:Pid";
					$sql1=$conn->prepare($query1);
					$sql1->bindParam(':Pid',$id,PDO::PARAM_STR);
					...
					<div class="flexslider">
						<ul class="slides">
							...
							<li data-thumb=<?php echo $img; ?>>
								 <div class="thumb-image"> <img src=<?php echo $img; ?> data-imagezoom="true" class="img-responsive" alt=""> </div>
							</li>
				...
				<div class="col-md-6 single-top-left simpleCart_shelfItem wow fadeInRight animated" data-wow-delay=".5s">
					...
					<h6 class="item_price">$ <?php echo $price; ?></h6>			
					<p><?php echo $des; ?></p>
					<ul class="size">
						<h4>Size</h4>
						<li><?php echo $size; ?></li>
					...
					<?php echo "<a href=wishInsert.php?id=$id&brand=$brand&name=$name&price=$price&img=$img  class=btn btn-inverse>;"?><i style="color: #ff5a10; font-size:22px" class="fa fa-heart-o"></i></a><br>
					<div class="btn_form">
						<?php echo "<a href=cartInsert.php?id=$id&name=$name class=add-cart item_add>ADD TO CART</a>	";?>
					</div>
				</div>
				<?php
