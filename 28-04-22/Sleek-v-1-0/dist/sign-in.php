            ...
            <div class="card-body p-5">
              ...
              <form method="post" >
                ...
                <div class="form-group col-md-12 mb-4">
                    <input type="text" class="form-control input-lg" id="name" aria-describedby="emailHelp" placeholder="Name" name="name">
                  </div>
                  <div class="form-group col-md-12 mb-4">
...
if(isset($_POST['Login'])){
    ...
    $a = "select * from adminpanel where Email='$email' and Password='$password'" ;
    //echo $a;
