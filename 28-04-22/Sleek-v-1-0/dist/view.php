...
$sql = "select * from $table where Pid='$id1'" ;
// echo $sql;
...
while($row=mysqli_fetch_array($query)){
    $id=$row["Pid"];
    echo "<tr>";    
    echo "<td rowspan=10>"."<img src=".$row["Image_path"]." height=300px width=200px ></td>";
    echo "</tr>";
    echo "<tr>";
    echo "<td>"."Product:".$row["Name"]."</td>";
    echo "</tr>";
    echo "<tr>";
    echo "<td>"."ID: ".$row["Pid"]."</td>";
    echo "</tr>";
    echo "<tr>";
    echo "<td>Brand: <b>".$row["Brand"]."</b></td>";
    echo "</tr>";
    echo "<tr>";
...
?>
<center>
<a href='collection.php?table=<?php echo $table ?>'>BACK</a>
</center>
