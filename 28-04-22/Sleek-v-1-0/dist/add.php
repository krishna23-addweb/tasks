      ...
      <div class="page-wrapper">
        ...
        <div class="content-wrapper">
          ...
          <div class="form-group">
            ...
            <input type="text" name="description" class="form-control" id="exampleFormControlInput3"/><br/><br/>
            </div>
            <div class="form-group">
            ...
            <input type="text" name="Color" class="form-control" id="exampleFormControlInput3"/><br/><br/>
            </div>
            <div class="form-group">
						<label for="exampleFormControlInput3">Enter Name:</label>
            <input type="text" name="Name" class="form-control" id="exampleFormControlInput3"/><br/><br/>
            </div>
...
$sql = "INSERT INTO $tab VALUES ('$id','$brand','$Color','$Size','$Price','$Product','$filepath','$name')";
move_uploaded_file($_FILES["file"]["tmp_name"], $filepath);
$query =mysqli_query($con, $sql);
if($query) 
{
  header("Location:collection.php?table=$tab");
} 
else 
{
echo "Error !!";
