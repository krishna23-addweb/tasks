                  ...
                  <form method="post">
                    <div class="row">
                      <div class="form-group col-md-12 mb-4">
                        <input type="text" class="form-control input-lg" id="name" aria-describedby="nameHelp" placeholder="Name" name="fname">
                      </div>
                      <div class="form-group col-md-12 mb-4">
                      ...
                      <div class="form-group col-md-12 mb-4">
                        <input type="text" class="form-control input-lg" id="address" aria-describedby="nameHelp" placeholder="Address" name="address">
                      </div>
                      <div class="form-group col-md-12 ">
...
if(isset($_POST['Register'])){
   $email= $_POST['email'];
     ...
     $abc="Insert into adminpanel (Email,Password,Name,Address,Mobile) values('$email','$password','$fname','$address',$phone)";
     echo $abc;
