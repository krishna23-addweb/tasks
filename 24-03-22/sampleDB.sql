...
CREATE TABLE `airport` (
  ...
  `to_where` varchar(20) DEFAULT NULL,
...
INSERT INTO `airport` (`id`, `name`, `from_where`, `to_where`, `phone`, `date_of_departure`) VALUES
(101, 'krishna', 'jaipur', 'delhi', 879465313, '2202-03-12'),
(102, 'tanisha', 'jaipur', 'mumbai', 879478513, '2202-05-12'),
(103, 'peehu', 'kishangarh', 'mumbai', 899478513, '2202-05-10'),
(104, 'mayank', 'delhi', 'jaipur', 845678513, '2202-02-11'),
(105, 'ashish', 'bangalore', 'jaipur', 878678513, '2202-02-21'),
(106, 'tripti', 'jaipur', 'pune', 878641213, '2202-04-30'),
(107, 'sakshi', 'mumbai', 'pune', 84641213, '2202-07-31'),
(108, 'harshita', 'mumbai', 'shimla', 844646213, '2202-08-31'),
(109, 'aarohi', 'delhi', 'shimla', 8446462122, '2202-04-23'),
(110, 'ridhi', 'kishangarh', 'hyderabad', 8446124122, '2202-11-20');
...
INSERT INTO `person_data` (`id`, `first_name`, `last_name`, `gender`, `zip`, `city`) VALUES
(1, 'krishna', 'agarwal', 'f', 46541, 'kishangarh'),
(2, 'tanisha', 'jain', 'f', 46531, 'kishangarh'),
(3, 'aaryan', 'jain', 'm', 46451, 'jaipur'),
(4, 'akshay', 'jain', 'm', 78451, 'jaipur'),
(5, 'gunjan', 'malviya', 'f', 74551, 'ajmer'),
(6, 'peehu', 'agarwal', 'f', 564123, 'lucknow'),
(7, 'prachi', 'sharma', 'f', 454124, 'ajmer'),
(8, 'shivam', 'goyal', 'm', 454124, 'kishangarh'),
(9, 'harsh', 'sharma', 'm', 845665, 'ajmer'),
(10, 'ankur', 'jain', 'm', 885665, 'ajmer');
