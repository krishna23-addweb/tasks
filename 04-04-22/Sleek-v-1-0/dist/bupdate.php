...
$query = mysqli_query($con,"select * from bottomwear where Bid='$id'") or die("error in query");
...
<input type="text" name="Material" value="<?php echo $material ?>" class="form-control" id="exampleFormControlInput3"/><br/>
</div>
            <div class="form-group">
						<label for="exampleFormControlInput3">Enter Fabric:</label>
<input type="text" name="Fabric" value="<?php echo $Fabric ?>" class="form-control" id="exampleFormControlInput3"/><br/>
</div>
Select image :
...
if(isset($_POST['Submit1'])){
    ...
    $query = mysqli_query($con,"update bottomwear set Brand_name='$brand',Product_Details='$product',Price=$price,Size_fit='$size',Material='$material',Fabric='$fabric',img_url='$img' where Bid='$id'") or die('error in query');
    if($query)
    {
