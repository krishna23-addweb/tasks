...
if(isset($_POST['Submit1'])){
    ...
    $query = mysqli_query($con,"update headphones set Brand_name='$brand',Product_Details='$product',Price=$price,img_url='$img' where Hid='$id'") or die('error in query');
    if($query)
    {
