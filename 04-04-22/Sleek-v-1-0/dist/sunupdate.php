...
$query = mysqli_query($con,"select * from sunglasses where SUNid='$id'") or die("error in query");
...
if(isset($_POST['Submit1'])){
    ...
    $query = mysqli_query($con,"update sunglasses set Brand_name='$brand',Product_Details='$product',Price=$price,Size_fit='$size',Material='$material',img_url='$img' where SUNid='$id'") or die('error in query');
    if($query)
    {
