...
if(isset($_POST['Submit1'])){
    ...
    $query = mysqli_query($con,"update footwear set Brand_name='$brand',Product_Details='$product',Price=$price,Size_fit='$size',Material='$material',Fabric='$fabric',img_url='$img' where Fid='$id'") or die('error in query');
    if($query)
    {
